 ...
 * 
 */
@WebServiceClient(name = "getCustomerDetail", targetNamespace = "http://soprabanking.com/amplitude", wsdlLocation = "file:/C:/git/mobiLoan/mobiLoan/smg-connectors/src/main/resources/wsdl/getCustomerDetail.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8088/mockgetCustomerDetailBinding?wsdl");
